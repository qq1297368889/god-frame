...
public interface BaseDao {
    ...
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param gzbtestId 实体类 主键ID
     * @return Gzbtest 实体类对象
     * */
    ...
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成查询语句
     * @return Gzbtest 实体类对象
     * */
    ...
    /**
     * 删除数据
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成Delete语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int gzbtestDelete(Gzbtest gzbtest);
    /**
     * 插入数据
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成Insert语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int gzbtestInsert(Gzbtest gzbtest);
    /**
     * 修改数据
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成Update语句 （while条件只能是 主键id）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
     ...
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int gzbtestInsertBatch(List<Gzbtest> list, boolean autoId);
    /**
     * 批量插入数据
     * @param list 实体类List 框架会根据该List对象生成Insert语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int gzbtestInsertBatch(List<Gzbtest> list);
    /**
     * 批量插入数据
     * @param sql sql语句
     * @param list list的每一条数据都与 sql的?对应
    ...
    /**
     * 异步批量插入数据
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成Inser语句
     * @param auto 为true时 自动给每个对象生成一个 主键id 否则 不做操作 默认为false
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    ...
    /**
     * 异步批量插入数据
     * @param gzbtest 实体类对象 框架会根据该实体类对象生成Inser语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    ...
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param test 实体类对象 框架会根据该实体类对象生成查询语句
     * @return Test 实体类对象
     * */
     ...
     * @return Test 实体类对象
     * */
    Test testFindCache(java.lang.Integer testId,int mm);
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param sql sql语句
     * @param arr 对应sql中的 ?
    ...
    /**
     * 删除数据
     * @param test 实体类对象 框架会根据该实体类对象生成Delete语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int testDelete(Test test);
    /**
     * 插入数据
     * @param test 实体类对象 框架会根据该实体类对象生成Insert语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int testInsert(Test test);
    /**
     * 修改数据
     * @param test 实体类对象 框架会根据该实体类对象生成Update语句 （while条件只能是 主键id）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
     ...
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int testInsertBatch(List<Test> list, boolean autoId);
    /**
     * 批量插入数据
     * @param list 实体类List 框架会根据该List对象生成Insert语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int testInsertBatch(List<Test> list);
    /**
     * 批量插入数据
     * @param sql sql语句
     * @param list list的每一条数据都与 sql的?对应
    ...
    /**
     * 异步批量插入数据
     * @param test 实体类对象 框架会根据该实体类对象生成Inser语句
     * @param auto 为true时 自动给每个对象生成一个 主键id 否则 不做操作 默认为false
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    ...
    /**
     * 异步批量插入数据
     * @param test 实体类对象 框架会根据该实体类对象生成Inser语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    ...
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param users 实体类对象 框架会根据该实体类对象生成查询语句
     * @return Users 实体类对象
     * */
     ...
     * @return Users 实体类对象
     * */
    Users usersFindCache(java.lang.Long usersId,int mm);
    /**
     * 查询单条数据，如果查询结果不是一条那么会返回 null
     * @param sql sql语句
     * @param arr 对应sql中的 ?
    ...
    /**
     * 删除数据
     * @param users 实体类对象 框架会根据该实体类对象生成Delete语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int usersDelete(Users users);
    /**
     * 插入数据
     * @param users 实体类对象 框架会根据该实体类对象生成Insert语句
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int usersInsert(Users users);
    /**
     * 修改数据
     * @param users 实体类对象 框架会根据该实体类对象生成Update语句 （while条件只能是 主键id）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
     ...
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int usersInsertBatch(List<Users> list, boolean autoId);
    /**
     * 批量插入数据
     * @param list 实体类List 框架会根据该List对象生成Insert语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    int usersInsertBatch(List<Users> list);
    /**
     * 批量插入数据
     * @param sql sql语句
     * @param list list的每一条数据都与 sql的?对应
    ...
    /**
     * 异步批量插入数据
     * @param users 实体类对象 框架会根据该实体类对象生成Inser语句
     * @param auto 为true时 自动给每个对象生成一个 主键id 否则 不做操作 默认为false
     * @return int 大于0为执行成功，小于0为出现异常
     * */
    ...
    /**
     * 异步批量插入数据
     * @param users 实体类对象 框架会根据该实体类对象生成Inser语句 且 自动给每个对象生成一个 主键id （自己给的id会被覆盖掉）
     * @return int 大于0为执行成功，小于0为出现异常
     * */
