...
public final class SystemAction extends BaseAction {
    public static Log log = new LogImpl(SystemAction.class);

    public String test(String msg1, String msg2, String msg3) {
        return Tools.json(1, msg1 + msg2 + msg3, "{}", "");
    }

    public String login(String, acc, String pwd, String code, int accSizeMin, int accSizeMax, int pwdSizeMin, int pwdSizeMax) {
        if (Tools.isString(acc, accSizeMin, accSizeMax) || Tools.isString(pwd, pwdSizeMin, pwdSizeMax) || Tools.isString(code, 4, 4)) {
